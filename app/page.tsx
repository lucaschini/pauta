...
export default function Home() {
  const { sources, columnData, wsConnected, lastUpdate, refreshColumn, refreshingCols } = useNews();
  ...
  const handleSave = useCallback((article: Article, sourceId: string) => {
      ...
      >
        {sources.length === 0 ? (
          ...
          >
            ...
            <span style={{ color: '#6b6b7a', fontSize: '11px' }}>
